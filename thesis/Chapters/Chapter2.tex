...
\begin{proposition}
  ...
  \item a natural transformation $\epsilon: FG\to I_C$ such that $\epsilon(x):Fx\to a$ is universal for every $x\in Ob(C)$. Conversely, we can define:
...
\begin{proposition}
  Each adjoint is completely determined by the items in any one of the following list:
  \begin{enumerate}
    \item {\color{red} TODO}
    \end{ennumerate}
  \end{proposition}
...
No se muy bien donde meterlo aún.