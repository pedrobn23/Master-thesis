...
\[
  \begin{tikzcd}
      c\arrow[r, "u"] \arrow[rd, "f"]      & Sd \arrow[d, "Sf'", dashed]& d\arrow[d,"f'"]\\
       &Se& e 
    \end{tikzcd}
  \]
...
%      c\arrow[r, "u"] \arrow[rd, "f"]
    \[
  \begin{tikzcd}
     *\arrow[r, "u"] \arrow[rd, "f"] & Sr \arrow[d, "Sf", dashed]& r\arrow[d,"f"]\\
      &Sd& d 
    \end{tikzcd}
  \]
  ...
  \begin{example}\ 
    ...
    \item Add the universal derived from the adjoint in lambeck isomorphism:
    \end{itemize}
  \end{example}
