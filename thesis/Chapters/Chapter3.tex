...
In lambda calculus we consider function as formulas, and thus, we consider an intensional approach. This intensional approach was also backed by the constructivist, to whom we will later on relate with the study of the Curry-Howard isomorphism  \cite{howard1980formulae} is from 1969.\\
...
\subsection{Fixed points and Programming in untyped-Lambda Calculus}
...
\subsection{Property oriented Propositional Logic}
