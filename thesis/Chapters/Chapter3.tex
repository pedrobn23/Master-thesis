...
\subsection{Reductions simply typed $\lambda$-calculus}
...
The already explained $\lambda$-calculus can be reduce to a slimmer version. In fact, the only type truly necessary are the function types,  
